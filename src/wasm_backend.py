...
class WASMCompiler:
    ...
    def _generate_helpers(self) -> List[str]:
        ...
        code.append("    ;; المجال الابتدائي: جذر 0 و1 مباشر لتجنب القسمة على صفر")
        code.append("    local.get $n")
        code.append("    i64.const 1")
        code.append("    i64.le_s")
        ...
        code.append("          i64.div_s")
        code.append("          local.set $x")
        code.append("          ;; إذا x >= prev، أعد التقدير السابق الأدنى")
        code.append("          local.get $x")
