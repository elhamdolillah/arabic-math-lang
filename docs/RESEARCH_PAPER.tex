...
\author{Ahmed Hamdani}
\authornote{الطالب أحمد --- الطالب}
\affiliation{%
...
\textbf{أمي سيبويه المكبولة} — أول مَن علّمني أن اللغة علمٌ وجمال.

\textbf{أبي حمداني — سيدي حمدي} — مَن غرس فيَّ حبَّ المعرفة منذ الصغر.

\textbf{جدتي نينة منت} — منبع الحكمة والصبر.

\textbf{أمي ريحانة} — قلبه وروحه.
