...
REGISTRIES = [
    ...
    ROOT / "protocol/MAL_ATTACHED_MECHANISMS_127_131_REGISTRY_AR.json",
    ROOT / "protocol/MAL_ATTACHED_MECHANISMS_137_142_REGISTRY_AR.json",
    ROOT / "protocol/MAL_ATTACHED_MECHANISMS_154_158_REGISTRY_AR.json",
]
CORPORA = [
    ...
    ROOT / "tests/MAL_ATTACHED_MECHANISMS_127_131_CORPUS_AR.json",
    ROOT / "tests/MAL_ATTACHED_MECHANISMS_137_142_CORPUS_AR.json",
    ROOT / "tests/MAL_ATTACHED_MECHANISMS_154_158_CORPUS_AR.json",
...
def main() -> int:
    ...
    print("ATTACHED_MECHANISMS=31-50,78-85,94-105,116-120,121-126,127-131,137-142,154-158")
